...
for (const locale of appLocales) {
  ...
  // Disabling this block from eslint because it takes try and catch as unnecessary blocks
  /* eslint-disable */
  try {
...
memoryTask.then((files) => {
  ...
  extractTask.then(() => {
    ...
    for (const locale of appLocales) {
      ...
      // Disabling this line because codacy doesn't allow none literals paths and reads the try as unnecessary block and this path is required to integrate prettier from react */
      /* eslint-disable */
      try {

 ...
 * Display BarChart with Reciprocating Engine Production data
...
const ReciprocatingEngineProduction = (props) => {
  ...
  const reciprocatingText = formatMessage(energyMessages.reciprocatingText);
...
/**
 * ReciprocatingEngineProduction PropTypes
 */
ReciprocatingEngineProduction.propTypes = {
...
export default injectIntl(ReciprocatingEngineProduction);
